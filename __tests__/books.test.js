...
beforeEach(async () => {
  let result = await db.query(`
    INSERT INTO
      ...
      VALUES(
        '12345',
        'https://amazon.com/express',
        'Sam',
        'English',
        250,
        'Express publishers',
        'best express book', 2023)
      RETURNING isbn`);
...
describe("POST /books", function () {
    test("Creates a new book", async function () {
      const response = await request(app)
          ...
          .send({
            isbn: '987654321',
            amazon_url: "https://flask.com",
            author: "Mr. Flask",
            language: "English",
            pages: 348,
            publisher: "Web Development Frameworks Publications",
    ...
    test("Prevents a bad book update", async function () {
      const response = await request(app)
          ...
          .send({
            ...
            pages: 348,
            publisher: "Web Development Frameworks Publications",
            title: "UPDATED Flask Framework",
            year: 2020,
            badUpdateField: "Over 20 Million Sold!"
          });
      expect(response.statusCode).toBe(400);
    });
